...
public class SqlFormatterUtils {
    ...
    public static void main(String[] args) {
        String sql = "create table `board_file_location_test` (\n" +
                "\t`file_id` BIGINT(20) not null comment '文件Id，对应表board_file的id',\n" +
                ...
                "\t`update_time` datetime(0) null comment '更新时间' default null ,\n" +
                "\tprimary key using BTREE (`file_id`)\n" +
                ") engine = INNODB character set = utf8 collate utf8_general_ci row_format = Dynamic comment='文件地理坐标记录';";
